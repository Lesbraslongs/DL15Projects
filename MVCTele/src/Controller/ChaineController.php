...
class ChaineController
{
    ...
    public function fetchAllAction(){
        $chaines = $this->chaineDAO->getAllChaines();//Model
        $vue = new View();
        echo  $vue->generer(array(
                                  array("dir"=>"chaine","file"=>"chaine", "nameValue"=>"chaines", "datas"=>$chaines)
                                     )
                                );
    ...
    public function detailAction(){
        ...
        if(isset($_GET['id'])){
            ...
            $vue = new View();
            echo  $vue->generer(array(
                                  array("dir"=>"chaine","file"=>"chaineOne", "nameValue"=>"chaine", "datas"=>$chaine)
                                     )
                                );
