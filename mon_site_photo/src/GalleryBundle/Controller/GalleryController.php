...
class GalleryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $galleries = $em->getRepository('GalleryBundle:Gallery')->findAll();
    ...
    {
        $gallery = new Gallery();
        $form = $this->createForm('GalleryBundle\Form\GalleryType', $gallery);
    ...
    {
        $deleteForm = $this->createDeleteForm($gallery);
        $editForm = $this->createForm('GalleryBundle\Form\GalleryType', $gallery);
