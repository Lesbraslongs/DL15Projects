			...
			<div class="product-container" itemscope itemtype="https://schema.org/Product">
							...
							<div class="content_price" itemprop="offers" itemscope itemtype="https://schema.org/Offer">
								{if isset($product.show_price) && $product.show_price && !isset($restricted_country_mode)}
									<span itemprop="price" class="price product-price">
										...
										<span class="price_euros_hover">{$product.explodePrice[0]}</span>
										<span class="currency_hover">{$currency->sign}</span>
										<span class="price_cents_hover">
											{if isset($product.explodePrice[1])}{$product.explodePrice[1]}{else}00{/if}
										</span>
									</span>
				...
				<div class="right-block">
					...
					<div class="content_price">
						{if isset($product.show_price) && $product.show_price && !isset($restricted_country_mode)}
							{hook h="displayProductPriceBlock" product=$product type='before_price'}
							<span class="price_euros">{$product.explodePrice[0]}</span>
								<span class="currency">{$currency->sign}</span>
								<span class="price_cents">
									{if isset($product.explodePrice[1])}{$product.explodePrice[1]}{else}00{/if}
								</span>
							</span>
							{if $product.price_without_reduction > 0 && isset($product.specific_prices) && $product.specific_prices && isset($product.specific_prices.reduction) && $product.specific_prices.reduction > 0}
