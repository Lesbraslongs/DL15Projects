...
namespace Proxies\__CG__\Iabsis\VideothequeBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \Iabsis\VideothequeBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'login', 'password', 'salt', 'userRoles'];
        }
    ...
    public function setSalt($value)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSalt', [$value]);
