...
class User implements UserInterface, \Serializable
{
     ...
     * Add userRoles
     *
     * @param \Iabsis\VideothequeBundle\Entity\Role $userRoles
     * @return User
     */
    public function addUserRole(\Iabsis\VideothequeBundle\Entity\Role $userRoles)
    {
     ...
     * @param \Iabsis\VideothequeBundle\Entity\Role $userRoles
     */
    public function removeUserRole(\Iabsis\VideothequeBundle\Entity\Role $userRoles)
    {
